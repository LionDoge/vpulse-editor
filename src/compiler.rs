...
fn traverse_nodes_and_populate(
    ...
    match current_node.user_data.template {
        ...
        PulseNodeTemplate::ForLoop => {
            ...
            let reg_idx = chunk.get_last_register_id() + 2; // + 1 would be the bool condition register
            let instr_copy = instruction_templates::copy_value(reg_from, reg_idx);
            ...
            chunk.add_register(String::from("PVAL_INT"), instr_add_id);
